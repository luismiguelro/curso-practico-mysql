...
SELECT 
    a.author_id, a.name, a.nationality, b.title
FROM
    authors AS a
        LEFT JOIN
    books AS b ON b.author_id = a.author_id
WHERE
    a.author_id BETWEEN 1 AND 10 
UNION SELECT 
    a.author_id, a.name, a.nationality, b.title
FROM
    authors AS a
...
-- CROSS JOIN devuelve todas las combinaciones posibles de filas de las tablas izquierda y derecha.
SELECT 
    *
FROM
    books
